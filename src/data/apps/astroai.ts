...
export const astroaiDocuments: AppLegalDocuments = {
    privacy: {
      ...
      <section>
        ...
        <ul style="list-style-type: disc; margin-left: 20px; margin-bottom: 1rem;">
          ...
          <li><strong>Communication Data:</strong> Any information you provide when you contact us for support or feedback.</li>
        </ul>
      </section>
      ...
      <section>
        ...
        <p>To provide a seamless experience, we may request the following permissions:</p>
        <ul style="list-style-type: disc; margin-left: 20px; margin-bottom: 1rem;">
          <li><strong>Location Services:</strong> We may request your current location to automatically determine your birth city's coordinates for higher precision. You can also enter this data manually.</li>
          <li><strong>Network Access:</strong> Required to connect to our secure servers for AI calculations and real-time planetary data.</li>
        </ul>
      </section>
      ...
      <section>
        ...
        <ul style="list-style-type: disc; margin-left: 20px; margin-bottom: 1rem;">
          <li>To generate your personalized natal chart and daily cosmic insights.</li>
          <li>To improve our AI models and overall application performance.</li>
      ...
      <section>
        ...
        <p>
          ...
          We may share generic aggregated demographic information not linked to any personal identification information with our business partners for analytical purposes.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          We retain your information as long as your account is active or as needed to provide you with our services. 
    ...
    terms: {
      ...
      <section>
        <h2>3. Disclaimer & Professional Advice</h2>
        <p>
      ...
      <section>
        ...
        <p>
          You are responsible for the accuracy of the birth data you provide. 
          You agree to use the app in compliance with all applicable laws and regulations.
        </p>
      </section>

      <section>
        <h2>5. AI Content & Predictions</h2>
        <p>
          The predictions and insights are generated by artificial intelligence. While we strive for accuracy based on 
          astrological principles, the nature of AI means that content may vary in its subjective resonance. 
          We do not guarantee the outcome of any event predicted in the app.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          without prior notice, for conduct that we believe violates these terms or is harmful to other users or the service.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          <br/>
          <a href="mailto:info@appxlab.space" style="color: #a78bfa;">info@appxlab.space</a>
        </p>
      </section>
    `
    }
