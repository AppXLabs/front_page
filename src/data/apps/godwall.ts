...
export const godwallDocuments: AppLegalDocuments = {
    privacy: {
        title: "God Wallpapers Privacy Policy",
      ...
      <section>
        ...
        <p>
          Welcome to God Wallpapers (Hindu God Wallpapers HD – Bhakti Images). We respect your privacy and are committed to protecting your personal data. 
  ...
  terms: {
      ...
      <section>
        ...
        <p>
          By downloading, installing, or using the God Wallpapers (Hindu God Wallpapers HD – Bhakti Images) mobile application, you agree to be bound 
      ...
      <section>
        ...
        <p>
          If you have any questions about these Terms and Conditions, please contact us at <a href="mailto:info@appxlab.space" style="color: #60a5fa; text-decoration: underline;">info@appxlab.space</a>
        </p>
      </section>
