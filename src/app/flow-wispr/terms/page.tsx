...
export default function FlowWisprTermsAndConditions() {
    const document = getDocument("flow-wispr", "terms");
            ...
            <footer className="bg-gray-900/50 border-t border-white/5 py-12">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row justify-between items-center gap-6">
                    ...
                    <div className="flex gap-6 text-sm font-medium">
                        <Link href="/flow-wispr/privacy" className="text-gray-400 hover:text-yellow-400 transition-colors">
                            Privacy Policy
                        </Link>
