...
export default function JaanuJiPrivacyPolicy() {
    const document = getDocument("jaanuji", "privacy");
        ...
        <div className="min-h-screen bg-pink-50 font-sans text-gray-900 selection:bg-pink-100 selection:text-pink-900">
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
                    <Link href="/jaanuji" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
                        <div className="w-8 h-8 bg-white rounded-full flex items-center justify-center overflow-hidden shadow-sm border border-pink-100">
                            <img src="/jaanuji/logo.webp" alt="AI Closr Logo" className="w-full h-full object-contain p-0.5" />
                        </div>
                        <span className="text-xl font-bold tracking-tight text-gray-900">AI Closr</span>
                    </Link>
            ...
            <footer className="bg-white/50 border-t border-pink-100 py-12">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row justify-between items-center gap-6">
                    <p className="text-gray-500 text-sm">&copy; 2025 AI Closr. All rights reserved.</p>
                    <div className="flex gap-6 text-sm font-medium">
                        <Link href="/jaanuji/terms" className="text-gray-600 hover:text-pink-600 transition-colors">
                            Terms & Conditions
                        </Link>
