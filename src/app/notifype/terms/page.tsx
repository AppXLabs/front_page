...
export default function NotifypeTermsAndConditions() {
    const document = getDocument("notifype", "terms");
            ...
            <header className="border-b border-slate-700 bg-slate-800">
                <div className="flex items-center justify-between p-4">
                    <div className="flex items-center space-x-4">
                        ...
                        <span className="text-lg font-medium text-slate-200">Notifype Terms & Conditions</span>
                    </div>
