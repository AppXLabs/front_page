...
import { ArrowLeft, Gavel, Scale, FileCheck } from "lucide-react";
import Image from "next/image";

export default function LunaFlowTerms() {
    const app = apps.find(a => a.id === "luna-flow");
    const document = app?.documents.terms;
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-pink-50 text-gray-800">
                <div className="text-center">
                    ...
                    <p className="text-gray-500 mb-6">Unable to load terms and conditions.</p>
                    <Link href="/luna-flow" className="text-purple-500 hover:text-purple-600 underline font-semibold">
                        Return Home
                    </Link>
                </div>
            </div>
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-pink-50 via-fuchsia-50/50 to-purple-50 font-sans text-gray-800 selection:bg-purple-400 selection:text-white">
            {/* Top accent line */}
            ...
            <nav className="border-b border-pink-200/60 bg-white/70 backdrop-blur-xl sticky top-0 z-50">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 h-20 flex items-center justify-between">
                    ...
                    <Link href="/luna-flow" className="text-xs font-semibold uppercase tracking-widest text-gray-400 hover:text-purple-500 transition-colors flex items-center gap-2">
            ...
            <main className="max-w-3xl mx-auto px-4 sm:px-6 py-20 md:py-32 relative">
                ...
                <div className="absolute top-0 left-0 w-64 h-64 bg-purple-200/20 rounded-full blur-[100px] -z-10"></div>

                <div className="mb-20 border-l-4 border-purple-400 pl-8">
                    <div className="flex items-center gap-2 text-purple-500 text-[10px] font-semibold uppercase tracking-[0.3em] mb-4">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-6 text-gray-400 text-[10px] font-semibold uppercase tracking-widest">
                        ...
                        <span className="hidden sm:inline w-1 h-1 bg-purple-300 rounded-full"></span>
                        <p>Contact: <a href={`mailto:${document.contactEmail}`} className="text-purple-500 hover:text-purple-600 transition-colors">{document.contactEmail}</a></p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-4 mb-20">
                    <div className="bg-white/80 p-6 rounded-2xl border border-purple-100 shadow-sm">
                        ...
                        <div className="text-gray-800 text-xs font-bold mb-1">Fair Use</div>
                        <div className="text-[10px] text-gray-400 font-medium leading-tight">Balanced user rights</div>
                    </div>
                    <div className="bg-white/80 p-6 rounded-2xl border border-pink-100 shadow-sm">
                        <FileCheck className="w-5 h-5 text-pink-500 mb-3" />
                        <div className="text-gray-800 text-xs font-bold mb-1">Compliant</div>
                        <div className="text-[10px] text-gray-400 font-medium leading-tight">Industry standards</div>
                    </div>
                    <div className="bg-white/80 p-6 rounded-2xl border border-rose-100 shadow-sm">
                        <Gavel className="w-5 h-5 text-rose-500 mb-3" />
                        <div className="text-gray-800 text-xs font-bold mb-1">Clear Terms</div>
                        <div className="text-[10px] text-gray-400 font-medium leading-tight">Easy to understand</div>
                    </div>
                </div>
                ...
                <div
                    className="prose max-w-none text-gray-600 font-medium leading-relaxed
                               ...
                               prose-strong:text-gray-800 prose-a:text-purple-500"
                    dangerouslySetInnerHTML={{
                        __html: document.content
                            .replace(/<h2>/g, '<h2 class="text-2xl font-bold text-gray-900 mt-20 mb-8 border-b border-purple-100 pb-4">')
            ...
            <footer className="bg-white/50 border-t border-pink-100 py-16">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row justify-between items-center gap-8">
                    ...
                    <div className="flex gap-8 text-[10px] font-semibold uppercase tracking-widest">
                        <Link href="/luna-flow/privacy" className="text-gray-400 hover:text-purple-500 transition-colors">
                            Privacy Policy
                        </Link>
                        <Link href="/luna-flow" className="text-gray-400 hover:text-purple-500 transition-colors">
                            Home
                        </Link>
                    </div>
                </div>
