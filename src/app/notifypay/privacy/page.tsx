...
export default function NotifypayPrivacyPolicy() {
    const document = getDocument("notifypay", "privacy");
            ...
            <footer className="bg-gray-50 border-t border-gray-100 py-12">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row justify-between items-center gap-6">
                    ...
                    <div className="flex gap-6 text-sm font-medium">
                        <Link href="/notifypay/terms" className="text-gray-600 hover:text-blue-600 transition-colors">
                            Terms of Service
                        </Link>
