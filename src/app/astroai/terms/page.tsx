...
export default function AstroAITerms() {
    const document = getDocument("astroai", "terms");
            ...
            <footer className="bg-gray-50 border-t border-gray-100 py-12">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row justify-between items-center gap-6 text-sm">
                    ...
                    <div className="flex gap-6 font-medium">
                        <Link href="/astroai/privacy" className="text-gray-500 hover:text-purple-600 transition-colors">
                            Privacy Policy
                        </Link>
